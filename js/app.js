/*
  ...
  版本: v1.8.2 (2026-05-02)
  更新内容:
    - **修正** 小星星吉他谱，根据标准 TAB 谱重新编写
    - 新增 RELEASE_NOTES.md 发布说明文档
...
var Scores = {
    ...
    /*
     * 曲目5-1: 小星星 (Twinkle Twinkle Little Star)
     * 说明: 经典儿歌，使用单音旋律
     * 时值: 八分音符（:8）和四分音符（默认）
     * 旋律: 1 1 5 5 | 6 6 5 - | 4 4 3 3 | 2 2 1 - |
     * 
     * 标准TAB谱（从下往上6-1弦，最下面=6弦，最上面=1弦）:
     *   八分5弦3品x2, 八分3弦空弦x2, 八分3弦2品x2, 四分3弦空弦
     *   八分4弦3品x2, 八分4弦2品x2, 八分4弦空弦x2, 四分5弦3品
     *   八分3弦空弦x2, 八分4弦3品x2, 八分4弦2品x2, 四分4弦空弦
     *   八分3弦空弦x2, 八分4弦3品x2, 八分4弦2品x2, 四分4弦空弦
     *   八分5弦3品x2, 八分3弦空弦x2, 八分3弦2品x2, 四分3弦空弦
     *   八分4弦3品x2, 八分4弦2品x2, 八分4弦空弦x2, 四分5弦3品
     * 
     * AlphaTex格式（品格.弦编号）:
     *   5弦3品=3.5, 3弦空弦=0.3, 3弦2品=2.3
     *   4弦3品=3.4, 4弦2品=2.4, 4弦空弦=0.4
     * 
     * 小节划分（每小节=4拍=8个八分音符）:
     *   第1小节: 5弦3品x2, 3弦空弦x2, 3弦2品x2, 3弦空弦(四分) = 4拍
     *   第2小节: 4弦3品x2, 4弦2品x2, 4弦空弦x2, 5弦3品(四分) = 4拍
     *   第3小节: 3弦空弦x2, 4弦3品x2, 4弦2品x2, 4弦空弦(四分) = 4拍
     *   第4小节: 3弦空弦x2, 4弦3品x2, 4弦2品x2, 4弦空弦(四分) = 4拍
     *   第5小节: 5弦3品x2, 3弦空弦x2, 3弦2品x2, 3弦空弦(四分) = 4拍
     *   第6小节: 4弦3品x2, 4弦2品x2, 4弦空弦x2, 5弦3品(四分) = 4拍
     * 
     * 音色: Distortion Guitar（失真吉他）
     * 调弦: 标准调弦 E A D G B E
     * 弦编号: 1(高E) 2(B) 3(G) 4(D) 5(A) 6(低E)
     */
    'twinkle': [
        '\\instrument "Distortion Guitar"',
        '\\tempo 80',
        '.',
        ':8 3.5 3.5 0.3 0.3 2.3 2.3 :4 0.3',
        ':8 3.4 3.4 2.4 2.4 0.4 0.4 :4 3.5',
        ':8 0.3 0.3 3.4 3.4 2.4 2.4 :4 0.4',
        ':8 0.3 0.3 3.4 3.4 2.4 2.4 :4 0.4',
        ':8 3.5 3.5 0.3 0.3 2.3 2.3 :4 0.3',
        ':8 3.4 3.4 2.4 2.4 0.4 0.4 :4 3.5'
    ].join('\n'),
